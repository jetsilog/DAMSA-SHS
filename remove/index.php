...
if (isset($_SESSION['fbUserId']) and $_SESSION['fbUserId'] != "") {
	header('location: http://localhost/damsashs/testing.php');
	exit;
}
			...
			<div class="col-sm-12 col-md-4 m-auto">
				<div class="border p-5 mb-5">
					...
					<form method="post">
						...
						<div class="form-group">
							<a href="<?php echo htmlspecialchars($loginUrl); ?>" class="btn btn-primary btn-block"><i class="fab fa-facebook-square"></i>Link with Facebook!</a>
						</div>
					</form>
				</div>
			</div>
