...
<body id="page-top">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Get average</li>
            </ol>
          </div>
                  ...
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody align="center">
                      ...
                      ?>
                        <tr>
                          <td><?= $rows['Section'] ?></td>
                          <td><a href="viewaverage.php?section=<?= $rows['Section']; ?>"><i class="fa fa-eye"></i></a></td>
  ...
  <script type="text/javascript">
    function editxid(x) {
      $.post('functions/get_average.php', {
          postid: x
        },
        function(data) {
          $('#result').html(data);
  ...
  <script>
    function getstudid(l) {
      document.getElementById("studid").value = l;
