            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <button type="button" class="btn btn-primary mb-1" data-toggle="modal" data-target="#addSection">Add Section</button>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody align="center">
                      <?php $query = mysqli_query($conn, "SELECT * FROM sections");

                      while ($rows = mysqli_fetch_array($query)) {
                      ?>
                        <tr>
                          <td><?php echo $rows['Section']; ?></td>
                          <?php $sections = $rows['Section']; ?>
                          <?php $result = mysqli_query($conn, "SELECT count(*) as totalstudents from students WHERE Stud_Section='$sections'");
                          $data = mysqli_fetch_assoc($result); ?>
                          <td><?php echo $data['totalstudents']; ?></td>

                          <?php
                          $status = $rows['Sec_status'];
                          if ($status == 0) {
                          ?>
                          ...
                          <td><a data-toggle="modal" data-target="#editSection" onclick="editxid(<?php echo $rows['ID']; ?>)"><i class="fa fa-edit"></i></a></td>
                          <td><a data-toggle="modal" data-target="#DeleteSection" onclick="deletexid(<?php echo $rows['ID']; ?>)"><i class="fa fa-trash"></i></a></td>
