            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Loads</h6>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      ?>
                      <?php $query = mysqli_query($conn, "SELECT * FROM class INNER JOIN track ON class.Track=track.TrackID INNER JOIN strand ON class.Strand=strand.StrandID INNER JOIN faculty ON class.Teacher=faculty.FacultyID INNER JOIN subjects ON class.Subject=subjects.ID INNER JOIN sections ON class.Section=sections.ID WHERE class.Teacher='$myusername'");
                      ...
                      ?>
                        ...
                        <tr align="center">
                          ...
                          <td><a style="color:grey" onmouseover="this.style.color='blue'" onmouseout="this.style.color='grey'" href="viewstudents.php?classcode=<?php echo $rows['ClassCode']; ?>"><i class="fa fa-eye"></i></a></td>
