            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">List of School Year</h6>
                  <button type="button" class="btn btn-primary mb-1" data-toggle="modal" data-target="#addSY">Add S.Y</button>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      <?php $query = mysqli_query($conn, "SELECT * FROM schoolyear");
                      ...
                      ?>
                        <tr>
                          ...
                          if ($status == 0) {
                          ?>
                            <td><a data-toggle="modal" data-target="#editSY" onclick="editxid(<?php echo $rows['ID']; ?>)"><i class="fa fa-edit"></i></a></td>
                            <td><a data-toggle="modal" data-target="#DeleteSY" onclick="deletexid(<?php echo $rows['ID']; ?>)"><i class="fa fa-trash"></i></a></td>
                          <?php   } else { ?>
                            <td><a data-toggle="modal" data-target="#editSY" onclick="editxid(<?php echo $rows['ID']; ?>)"><i class="fa fa-edit"></i></a></td>
                            <td><a data-toggle="modal" data-target="#Deleteerror" onclick="deletexid(<?php echo $rows['ID']; ?>)"><i class="fa fa-trash"></i></a></td>
                          <?php } ?>
                        </tr>
                      <?php  } ?>
                    </tbody>
