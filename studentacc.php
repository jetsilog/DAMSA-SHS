...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Student Account</h1>
            <ol class="breadcrumb">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      <?php $query = mysqli_query($conn, "SELECT * FROM accounts WHERE AccountType='Student'");
                      ...
                      ?>
                        <tr>
                          ...
                          <td><a data-toggle="modal" data-target="#editAccount" onclick="editxid(<?php echo $rows['ID']; ?>)"><i class="fa fa-edit"></i></a></td>
                          <?php if ($usertype == 'Co-admin') { ?>
          ...
          <div class="modal fade" id="DeleteAccount" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="functions/delete_studentacc.php" method="POST">
          ...
          <div class="modal fade" id="editAccount" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Edit Student Account</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <form action="functions/edit_studentacc.php" method="POST">
                  <div class="modal-body">
                    <div id='result'></div>
                  </div>
                  <div class="modal-footer">
  ...
  <script type="text/javascript">
    function editxid(x) {
      $.post('functions/get_studentacc.php', {
          postid: x
        },
        function(data) {
          $('#result').html(data);
